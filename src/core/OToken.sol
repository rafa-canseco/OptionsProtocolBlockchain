...
contract OToken is ERC20 {
    ...
    uint    public strikePrice; // scaled to 8 decimals (e.g., $2000 = 200000000000)
    uint    public expiry; // unix timestamp, must be 08:00 UTC
    bool    public isPut;
    ...
    function mintOtoken(address _to, uint _amount)
        external
        onlyController
    {
        _mint(_to, _amount);
    ...
    function burnOtoken(address _from, uint _amount)
        external
        onlyController
    {
        _burn(_from, _amount);
