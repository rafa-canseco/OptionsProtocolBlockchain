...
/// @notice One-shot B1N-360 factory restricted to the supervised Base Sepolia deployment.
/// @dev Production factories retain governance delays. This deployment-only specialization
///      creates one paused testnet fund with zero AccessManager delays.
contract B1N360ZeroDelayFundFactory is FundFactory {
