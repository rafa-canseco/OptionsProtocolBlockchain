...
contract SmokeTestBeta is Script {
    ...
    OTokenFactory constant factory =
    ...
    MarginPool constant pool =
        MarginPool(0x727ddBD04A691E73feaE26349F48144953Ef20d6);
    MockERC20 constant lbtc =
        MockERC20(0x39fA11EbBE82699Fd9F79C566D7384064571d2b4);
    MockERC20 constant lusd =
        MockERC20(0xAB51a471493832C1D70cef8ff937A850cf37c860);
    ...
    function run() external {
        ...
        controller.depositCollateral(
            deployer, vaultId, address(lbtc), collateralAmount
        );
        ...
        controller.mintOtoken(
            deployer, vaultId, oTokenAddr, mintAmount, deployer
        );
